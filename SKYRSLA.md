...
Í **Plötu** getur þú leitað upp plötur í gegnum Musicbrainz í fallegu ✨tailwind✨ viðmóti. Þú getur bætt þeim í safnið þitt, og gefið plötunum einkunn

## Tækni
(hvaða tækni er notuð og af hverju)
### Tech stack
- Hono
- React + Vite + Tailwaind framendi
- 
Upprunalega notaði ég MusicBrainz, en ég skipti yfir í Last.fm API útaf nokkrum ástæðum

## Hvað gekk vel og hvað gekk illa?
(hvað gekk vel?)
(hvað gekk illa?)
(hvað var áhugavert?)
